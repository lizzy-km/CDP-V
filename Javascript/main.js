...
လုပ်ဆောင်ချက်ထည့်ပါ(ခလုတ်)(နှိပ်ပါ, () => {
  const စစ်ထုတ်ထားသော_အမည် = အမည်ဖြင့်_စစ်ထုတ်ပါ(အမဲပန်းအဖွဲ့, ထည့်သွင်းထားသောအမည်.value).map(
    (အမဲပန်း) => အမဲပန်း.အမည်
  );
  const သေတ္တာ = သေတ္တာအသစ်ကိုဖန်တီးပါ("div");
  const စာသားအသစ် = စာသားအသစ်ဖန်တီးပါ(စစ်ထုတ်ထားသော_အမည်.length > 0 ? စစ်ထုတ်ထားသော_အမည် : 'မရှိပါ။');
